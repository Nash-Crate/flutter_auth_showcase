...
@singleton
class LoginWithEmailPasswordSuperbase implements Usecase<AuthUser, LoginWithEmailPasswordParams> {
  /// Constructor for the use case
  const LoginWithEmailPasswordSuperbase(this._loginRepository);

  final ILoginRepository _loginRepository;

  @override
  Future<Either<Failure, AuthUser>> call(LoginWithEmailPasswordParams params) {
    return _loginRepository.loginWithEmailPasswordSuperbase(params);
  }
}
