...
@singleton
class RegisterWithEmailPasswordFirebase implements Usecase<Unit, RegisterWithEmailPasswordParams> {
  /// Constructor for the use case
  const RegisterWithEmailPasswordFirebase(this._registerRepository);

  final IRegisterRepository _registerRepository;

  @override
  AsyncFailT<Unit> call(RegisterWithEmailPasswordParams params) {
    return _registerRepository.registerWithEmailPasswordFirebase(params);
  }
}
